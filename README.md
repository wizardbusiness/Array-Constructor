V1- This program creates arrays of random positive and negative integers between -100 and 100. The user specifies the length of the array in the input, and then clicks 'create array' to generate an array.
